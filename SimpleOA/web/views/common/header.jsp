                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="#" onclick="changeClass($('#personinf'),'<%=base+path%>/views/pages/account.jsp')"><i class="icon-user"></i>个人设置</a>
                            </li>
                            <li>
                                <a href="#" onclick="changeClass($('#personinf'),'<%=base+path%>/views/pages/changePassword.jsp')"><i class="icon-lock"></i> 修改密码</a>
                            </li>
                            <li class="divider"></li>
                            <li>
