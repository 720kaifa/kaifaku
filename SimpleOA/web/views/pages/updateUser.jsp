...
<script src="<%=base + path %>/views/pages/js/updateUser.js"></script>
                ...
                <div class="tab-pane active">
                    ...
                    <fieldset>
                        ...
                        <div class="form-actions">
                            <button type="button" class="btn btn-primary" id="cha" style="margin-left: 150px" button>修改</button>
                            <button type="button" class="btn btn-primary" id="sub" button>保存</button>
