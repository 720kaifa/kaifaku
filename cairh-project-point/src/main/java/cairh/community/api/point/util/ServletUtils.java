...
public class ServletUtils {
	...
	public static <T> T getParamFromRequest(String param,ServletRequest request){
	...
	public static String encodeHttpBasic(String userName, String password) {
	 ...
	 /**
     * @param request
     * @return http://www.htsec.com/action/post.htm?method=add
     */
    ...
    public static boolean isRobot(HttpServletRequest request) {
		...
		if (StringUtils.isNotBlank(userAgent)) {
			if (userAgent.contains("Baiduspider")||userAgent.contains("Googlebot")) {
				return true;
			} 
		}
		return false;
