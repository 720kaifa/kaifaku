...
<script src="<%=base + path %>/views/pages/js/news.js"></script>
...
<div class="widget widget-table" id="newslist">
    ...
    <div class="widget-content">
        ...
        <table class="table table-striped table-bordered simpleoa-table">
            ...
            <tr>
                ...
                <th width="15%" style="text-align: center;">新闻题目</th>
                <th width="25%" style="text-align: center;">新闻内容</th>
                ...
                <div class="tab-pane active">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group div-hidden">
                            <label class="control-label div-left div-width" for="title">新闻题目</label>
