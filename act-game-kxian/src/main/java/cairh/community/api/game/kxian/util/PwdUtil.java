...
public class PwdUtil {
    ...
    /**
     * base64解密3次
     * VFZSbmVrNXFZelJOYW1zMFQwUlpQUT09 
     * VFZSbmVrNXFZelJOYW1zMFQwUkZQUT09
     * VFZSbmVrNXFZelJOYW1zMFQwUkJQUT09
     * @param mobileNo
     * @return
     * @throws Exception
     */
    public static String MobileEncode(String mobileNo) throws Exception {
    	 mobileNo = new String(Base64.decodeBase64(mobileNo.getBytes(UTF_8)), UTF_8);
         mobileNo = new String(Base64.decodeBase64(mobileNo.getBytes(UTF_8)), UTF_8);
         mobileNo = new String(Base64.decodeBase64(mobileNo.getBytes(UTF_8)), UTF_8);
         return mobileNo;
    }
